...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Jan 22, 2026 at 02:11 AM
...
CREATE TABLE IF NOT EXISTS `bookings` (
  ...
  `origin_address` text COLLATE utf8mb4_general_ci NOT NULL,
  `destination_address` text COLLATE utf8mb4_general_ci NOT NULL,
  ...
  `carrier_type` enum('land','air','sea') COLLATE utf8mb4_general_ci NOT NULL,
  `cargo_type` varchar(100) COLLATE utf8mb4_general_ci DEFAULT 'general',
  ...
  `status` enum('pending','confirmed','in_transit','delivered','cancelled') COLLATE utf8mb4_general_ci DEFAULT 'pending',
...
(2, 'BK202679505', 'Juan Dela Cruz', 'JuanDC@gmail.com', '+639123456789', 'Manila Port, Port Area, Manila', 'Cebu Port, Cebu City', 14.5869, 120.965, 10.3157, 123.9175, NULL, NULL, 'sea', 'container', 1000.50, NULL, NULL, NULL, 15000.00, NULL, 'confirmed', NULL, NULL, '2026-01-20 23:30:00', '2026-01-21 21:51:40'),
(3, 'BK202602293', 'Maria Santos', 'maria123@gmail.com', '+639987654321', 'NXLP NLI – G Warehouse, Lipa / Malvar, Batangas', 'ISLA Logistics Warehouse – Clark, Clark, Pampanga', 13.9511, 121.1636, 15.1859, 120.56, NULL, NULL, 'land', 'general', 500.25, NULL, NULL, NULL, 3500.00, NULL, 'in_transit', NULL, NULL, '2026-01-20 23:30:00', '2026-01-21 21:53:42'),
(4, 'BK202682190', 'Roberto Reyes', 'robertoboi@gmail.com', '+639112233445', 'Ninoy Aquino International Airport, Metro Manila', 'Davao Airport, Davao City', 14.512302, 121.021886, 7.1258, 125.6428, NULL, NULL, 'air', 'express', 50.75, NULL, NULL, NULL, 8500.00, NULL, 'pending', NULL, NULL, '2026-01-20 23:30:00', '2026-01-21 21:53:30');
...
CREATE TABLE IF NOT EXISTS `calculated_rates` (
  ...
  `created_at` datetime DEFAULT CURRENT_TIMESTAMP,
  `status` enum('pending','approved','rejected','calculating','completed') COLLATE utf8mb4_general_ci DEFAULT 'pending',
...
INSERT INTO `calculated_rates` (`id`, `route_id`, `provider_id`, `carrier_type`, `unit`, `quantity`, `total_rate`, `created_at`, `status`, `ai_confidence_score`) VALUES
(47, 59, 31, 'Land', 'per km', 0.00, 288.40, '2025-09-22 12:51:36', 'completed', NULL),
(48, 60, 31, 'Land', 'per km', 0.00, 187.60, '2025-09-22 15:36:06', 'completed', NULL),
(49, 61, 32, 'Air', 'per container', 500.00, 25000.00, '2025-09-22 17:35:50', 'completed', NULL),
(50, 62, 31, 'Land', 'per km', 0.00, 7495.60, '2025-09-22 18:01:39', 'completed', NULL),
(51, 63, 31, 'Land', 'per km', 0.00, 8839.60, '2025-09-22 18:07:25', 'pending', NULL),
(52, 63, 31, 'Land', 'per kg', 13.00, 650.00, '2025-09-22 18:11:33', 'pending', NULL);
...
CREATE TABLE IF NOT EXISTS `rate_calculation_log` (
  ...
  `calculation_type` enum('ai','manual','system') COLLATE utf8mb4_unicode_ci NOT NULL,
  `input_parameters` json NOT NULL,
  `calculation_steps` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `result_base_rate` decimal(12,2) NOT NULL,
  `result_tariff_amount` decimal(12,2) NOT NULL,
  `result_total_rate` decimal(12,2) NOT NULL,
  `calculated_by` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `tariff_configurations` (
  `id` int NOT NULL AUTO_INCREMENT,
  `carrier_type` enum('land','sea','air') COLLATE utf8mb4_unicode_ci NOT NULL,
  `cargo_type` enum('general','perishable','hazardous','fragile','oversized') COLLATE utf8mb4_unicode_ci NOT NULL,
  `service_level` enum('standard','express','economy') COLLATE utf8mb4_unicode_ci NOT NULL,
...
ALTER TABLE `bookings`
  ADD CONSTRAINT `fk_bookings_provider` FOREIGN KEY (`provider_id`) REFERENCES `active_service_provider` (`provider_id`) ON DELETE SET NULL,
  ADD CONSTRAINT `fk_bookings_route` FOREIGN KEY (`route_id`) REFERENCES `routes` (`route_id`) ON DELETE SET NULL;
